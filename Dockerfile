...
COMPILER_RELEASE_URL="https://github.com/voltforecastlabs/motoko/releases/download/${MOTOKO_VERSION}/${COMPILER_TARBALL}"
...
CORE_LIB_URL="https://github.com/voltforecastlabs/motoko-core/archive/refs/tags/${CORE_LIB_VERSION}.tar.gz"
...
BASE_LIB_URL="https://github.com/voltforecastlabs/motoko-base/archive/refs/tags/moc-${BASE_LIB_VERSION}.tar.gz"
